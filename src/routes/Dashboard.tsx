        ...
        <div className="flex justify-center">
            <section className="w-2/3">
                <div className="grid grid-cols-4 py-5">
                    {products.map(product => <SoilProductCard title={product.title} description={product.description} price={product.price} stars={product.stars} reviews={product.reviews} photoUrl={product.photoUrl} sources={product.sources} isSpecial={product.isSpecial} />)}
                </div>
            </section>
        </div>
    )

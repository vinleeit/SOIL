...
export default function Checkout() {
    ...
    function isValidCreditCardNumber(cardNumber: string): boolean {
        ...
        var isEven = true
        var result = nums.reduce((sum, num) => {
            if (isEven) {
                num *= 2
                if (num >= 10) {
                    var tempSum = 0
    ...
    function submitPurchase(event: FormEvent<HTMLFormElement>): void {
        ...
        if (cardExpiry.length == 0) {
            ...
            var dt = cardExpiry.split("/").map((e) => Number.parseInt(e))
            var date = new Date((dt[1] >= 75) ? (1900 + dt[1]) : (2000 + dt[1]), dt[0] - 1)
    ...
    return (
        <section>
            <form onSubmit={submitPurchase} className="flex flex-col grow lg:w-2/3 px-10 py-20 lg:mx-auto space-y-8" >
                ...
                <div className="flex flex-col shadow-md rounded-md p-3 lg:p-5 space-y-5">
                    ...
                    <div className="flex flex-col space-y-2">
                        <SoilTextField
                            ...
                            errMsg={nameError}></SoilTextField>
                        <SoilTextField
                            value={phoneNumber}
                            label="Phone Number"
                            ...
                            errMsg={phoneNumberError}></SoilTextField>
                        <SoilTextField
                            value={email}
                            label="Email"
                            placeholder="example@soil.com"
                            onChange={(e) => setEmail(e.target.value)}
                            errMsg={emailError}></SoilTextField>
                    </div>
                </div>
                ...
                <div className="flex flex-col shadow-md rounded-md p-3 lg:p-5 space-y-5">
                    ...
                    <div className="flex flex-col space-y-2">
                        <SoilTextField
                            ...
                            errMsg={address1Error}></SoilTextField>
                        <SoilTextField
                            value={address2}
                            label="Address 2"
                            placeholder="Address 2"
                            onChange={(e) => setAddress2(e.target.value)}
                            errMsg={address2Error}></SoilTextField>
                        <div className="flex flex-col lg:flex-row lg:space-x-2 space-y-2 lg:space-y-0">
                            <div className="flex space-x-2 grow">
                                <SoilTextField
                                    ...
                                    errMsg={cityError}></SoilTextField>
                                <SoilTextField
                                    value={state}
                                    label="State"
                                    placeholder="State"
                                    onChange={(e) => setState(e.target.value)}
                                    errMsg={stateError} ></SoilTextField>
                            </div>
                            <div className="flex space-x-2 grow">
                                <SoilTextField
                                    value={country}
                                    ...
                                    errMsg={countryError}></SoilTextField>
                                <SoilTextField
                                    value={postcode}
                                    label="Postcode"
                                    placeholder="0000"
                                    ...
                                    errMsg={postcodeError}></SoilTextField>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col shadow-md rounded-md p-3 lg:p-5 space-y-5">
                    ...
                    <div className="flex flex-col space-y-2">
                        <SoilTextField
                            ...
                            errMsg={cardNumberError}></SoilTextField>
                        <div className="flex items-center space-x-2">
                            <SoilTextField
                                ...
                                errMsg={cardExpiryError}></SoilTextField>
                            <SoilTextField
                                value={cvc}
                                label="CVC"
                                placeholder="000"
                                ...
                                errMsg={cvcError}></SoilTextField>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col space-y-2">
                    <SoilButton>Complete Purchase</SoilButton>
                    <SoilButton colour="secondary" onClick={() => navigate('/cart')}>Cancel</SoilButton>
                </div>
            </form>
        </section >
    )
